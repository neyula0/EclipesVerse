...
const API_BASE = window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1'
    ? 'http://localhost:5000/api/animekompi'
    : 'https://indocast.site/api/animekompi';

const API_KEY = 'f04a9d96363e28536243736bdad891fdcbed9408008c09358d6c0af0365a4d1b';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log('🚀 EclipesVerse v2.0 loaded');
});
